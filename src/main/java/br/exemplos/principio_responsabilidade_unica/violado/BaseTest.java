...
public class BaseTest {
    ...
    @Test
    public void testBoarNovePontos() {
        Board board = new Board();
        assertEquals(9, board.pontos.size());
    }
    ...
    public void testPrimeiraRodada() {
        ...
        assertEquals(rowOne, board.primeiraRodada());
    }
    ...
    public void testSegundaRodada() {
        ...
        assertEquals(rowTwo, board.segundaRodada());
    }
    ...
    public void testTerceiraRodada() {
        ...
        assertEquals(rowThree, board.terceiraRodada());
    }

    @Test
    public void testExibirNoConsole() {
        Board board = new Board();
